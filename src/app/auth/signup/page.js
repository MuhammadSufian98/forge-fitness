        ...
        <section className="relative hidden md:flex md:w-1/2 overflow-hidden bg-[#071952] p-8 lg:p-12 flex-col justify-between">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <p className="text-white/50 font-medium text-xs leading-relaxed max-w-[280px]">
                Experience precision fitness training with data-driven insights
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <p className="text-white/30 text-[9px] font-black uppercase tracking-widest">
              50k+ Athletes Enlisted
            </p>
          </div>
        </section>

        {/* RIGHT SIDE: Signup Form */}
        <section className="flex-1 bg-white flex flex-col items-center justify-center p-6 relative overflow-y-auto custom-scrollbar">
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-[320px] lg:max-w-[360px] space-y-5"
          >
            <header className="text-center md:text-left space-y-1">
              <h2 className="text-3xl font-black text-[#071952] uppercase tracking-tighter italic leading-none">
                Join{" "}
                <span className="text-[#088395] not-italic">the Elite</span>
              </h2>
            ...
            <form className="space-y-3" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-[#f2f3f6] border-none rounded-xl py-3 pl-12 pr-4 text-[#071952] font-bold text-xs focus:ring-1 focus:ring-[#35a29f] transition-all outline-none"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <select
                    ...
                    className="w-full bg-[#f2f3f6] border-none rounded-xl py-3 pl-12 pr-8 text-[#071952] font-bold text-xs focus:ring-1 focus:ring-[#35a29f] transition-all outline-none appearance-none cursor-pointer"
                    required
                  >
              ...
              {error && (
                <div className="p-2 bg-red-50 border border-red-200 rounded-lg text-red-700 text-[9px] font-bold">
                  {error}
                </div>
              )}
            ...
            <footer className="pt-4 border-t border-[#f2f3f6] text-center space-y-2">
              <p className="text-[#071952]/30 text-[9px] font-black uppercase tracking-widest leading-none">
                Already Enlisted?
              </p>
              <Link
                href="/auth/login"
                className="inline-flex items-center gap-2 bg-[#f2f3f6] px-6 py-2.5 rounded-lg text-[#071952] font-black text-[9px] uppercase tracking-[0.2em] hover:bg-[#071952] hover:text-white transition-all group"
              >
                Access Terminal
                <Dumbbell
                  size={14}
