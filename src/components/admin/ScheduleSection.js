...
export default function ScheduleSection() {
  ...
  const filteredSchedules = useMemo(() => {
    if (activeTab === "Upcoming")
      return schedules.filter((s) => s.currentStatus === "Upcoming");
    if (activeTab === "Live")
      return schedules.filter((s) => s.currentStatus === "Live");
    if (activeTab === "History")
      return schedules.filter((s) => s.currentStatus === "Expired");
    return schedules;
  }, [schedules, activeTab]);
        ...
        <div className="max-w-[1400px] mx-auto space-y-10">
          ...
          <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <div className="flex bg-white/50 p-1 rounded-2xl border border-[#071952]/5 mt-4 w-fit">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative">
            ...
            <div className="lg:col-span-8 space-y-6 relative border-l-2 border-[#071952]/5 ml-4 pl-10">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-[10px] font-black text-[#071952]/40 uppercase tracking-[0.4em]">
                  {activeTab} Session Pipeline
                </h3>
                {activeTab === "Live" && filteredSchedules.length > 0 && (
              ...
              {filteredSchedules.length === 0 ? (
                <div className="bg-white/50 border-2 border-dashed border-[#071952]/5 rounded-[2.5rem] py-20 flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-sm font-medium text-[#071952]/40 mt-2 max-w-xs">
                    No {activeTab.toLowerCase()} sessions detected in this
                    sector.
                  </p>
                </div>
              ) : (
                filteredSchedules.map((item) => {
                  const isExpired = item.currentStatus === "Expired";
                  const isLive = item.currentStatus === "Live";
                  ...
                  return (
                    <motion.div
                      ...
                      className={`relative bg-white p-8 rounded-[2.5rem] border border-[#071952]/5 cursor-pointer transition-all group ${isExpired ? "opacity-60 grayscale-[0.5]" : "hover:shadow-2xl"}`}
                    >
                      <div
                        className={`absolute -left-[49px] top-1/2 -translate-y-1/2 w-4 h-4 rounded-full border-4 border-[#f2f3f6] ${isLive ? "bg-red-500 animate-pulse" : isExpired ? "bg-gray-400" : "bg-[#071952]/20"}`}
                      />
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                        <div className="flex items-center gap-8">
                          <div className="text-center min-w-[70px]">
                            <span
                              className={`block text-xl font-black leading-none ${isExpired ? "text-gray-500" : "text-[#071952]"}`}
                            >
                          ...
                          <div>
                            <div className="flex items-center gap-3">
                              <h4
                                className={`text-2xl font-black uppercase italic leading-none ${isExpired ? "text-gray-500" : "text-[#071952]"}`}
                              >
                                {item.title}
                              </h4>
                              {isLive && (
                              ...
                              {item.isDaily && (
                                <span className="bg-[#088395]/10 text-[#088395] text-[8px] font-black px-2 py-0.5 rounded-full flex items-center gap-1">
          ...
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
            ...
            >
              <div className="p-8 lg:p-12 bg-[#071952] text-white shrink-0">
                ...
                <p className="text-[#088395] font-black text-xs uppercase tracking-[0.3em]">
              ...
              <div className="flex-1 overflow-y-auto p-8 lg:p-12 custom-scrollbar">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-[11px] font-black text-[#071952] uppercase tracking-[0.3em] flex items-center gap-3">
                    <ShieldCheck size={18} className="text-[#088395]" />{" "}
                    Verified Athlete Enrollment
                  </h3>
                ...
                <div className="space-y-4">
                  ...
                  selectedClass.enrolledUsers.length === 0 ? (
                    <div className="py-20 flex flex-col items-center justify-center text-center bg-[#f2f3f6] rounded-[2rem] border-2 border-dashed border-[#071952]/5">
                      ...
                      <p className="text-sm font-black text-[#071952]/20 uppercase italic tracking-widest">
                    ...
                    selectedClass.enrolledUsers.map((athlete, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="text-sm font-black text-[#071952] uppercase italic leading-none">
                              {athlete.fullName}
                            </p>
                            <p className="text-[9px] font-bold text-[#071952]/30 uppercase mt-1 tracking-widest">
                              {athlete.email}
                            </p>
                          </div>
                        </div>
                        <BadgeCheck
                          size={20}
                          className="text-[#088395] opacity-0 group-hover:opacity-100 transition-opacity"
                        />
                      </motion.div>
                    ))
                  )}
